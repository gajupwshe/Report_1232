...
while($row = $result->fetch_assoc()){ // use fetch_assoc
    try {
        ...
        //     if($flag_1=1){
        //         $flag_1=0;
        //         $holding_start="Holding start @ ".$row['time'];
        //               }
        //                     $dataPoints1[] = array("label" => $row['date_time'], "y" =>     $pressure, "indexLabel"=>   $holding_start, "markerType"=> 'circle',"markerColor"=>'red', 'markerSize'=>12);
                            
        // }else   if($row['hold_start']==$holding_set){
        //         if($flag==1){
        //             $flag=0;
        //         $holding_end="Holding End @ ".$row['time'];
        //                 $dataPoints1[] = array("label" => $row['date_time'], "y" => $pressure,"indexLabel"=>$holding_end, "markerType"=> 'circle',"markerColor"=>'red', 'markerSize'=>12);
                        
        //         }else{
        //             $dataPoints1[] = array("label" => $row['date_time'], "y" => $pressure);
                    
        //         }
        //                   //   $dataPoints[] = array ("label" => $row['time'], "y" => $row['pressure'], indexLabel: "high", markerType: "triangle",markerColor: "red", markerSize: 12 );
