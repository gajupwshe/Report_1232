...
//                                    echo "end day is ". $two."<br>";
                                   ...
                                   $sql ="SELECT ti.*,tr.`test_result`,tr.`mt`,tr.`pressure_unit` FROM `valve_data` ti, test_result tr  WHERE ti.test_no = tr.test_no AND  ti.test_type = tr.test_type AND  ti.`date`  BETWEEN '$one' AND '$two'";
                                    ...
                                    do { ?>
                                        ...
                                        <?php } ?>
                                           ...
                                           <!--  <?php
                                            ...
                                            <td align="center" valign="middle">
                                                <a href="new_vtr_reports_dbb.php?valve_serial_no=<?php echo $row['vsn']; ?>&company=<?php echo $row['company'];?>"
