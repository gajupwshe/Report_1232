...
//                                    echo "end day is ". $two."<br>";
                            ...
                            $sql ="SELECT ti.`date`,ti.`test_no`,ti.`vsn`,ti.`holding_set`,ti.`test_type`,ti.`hydro_set_pressure`,tr.`test_result` FROM `valve_data` ti, test_result tr  WHERE ti.test_no = tr.test_no AND  ti.test_type = tr.test_type AND  ti.`date` BETWEEN '$one' AND '$two'";
